...
const EcomUserState = ({children}) => {
    ...
    const handlePayment =async(userId,receipt,amount)=>{
        try{
            ...
            const {data} = await axios.post('https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/payment/createOrder',{
                amount:amount,
                currency:"INR",
                receipt:receipt,
                userId,
            ...
            const options ={
                ...
                handler:async (response) =>{
                    const verifyUrl = 'https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/payment/verifyPayment'
    ...
    const getProducts = async()=>{
        try{
            const data = await fetch('https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/allProduct',{
                method:"GET",
    ...
    const getnewProducts = async()=>{
        try{
            const data = await fetch("https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/newProduct",{
                method:"GET",
    ...
    const getfeatured = async()=>{
        try{
            const data = await fetch("https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/getFeatured",{
                method:"GET",
                headers:{
                    "Content-Type":"application/json"
                }
    ...
    const cartProducts = async() =>{
        try{
            const data = await fetch('https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/cartproduct',{
                method:"POST",
    ...
    const updatingAddress = async(phoneNo,address,postal,city,country) =>{
        ...
        try{
            ...
            const data = await fetch('https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/addingaddress',{
                method:"POST",
    ...
    const viewdetails = async() =>{
        try{
            ...
            const res = await fetch(`https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/viewsdetails/${usersId}`,{
                method:"GET",
    ...
    const productshowcase = async(productid) =>{
        try{
            const res = await fetch(`https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/product/${productid}`,{
                method:"GET",
    ...
    const findorders = async() =>{
        try{
            const res = await fetch(`https://ecommercefullstack-cck3abo4z-navneet-shahis-projects-727aeff0.vercel.app/user/order/${usersId}`,{
                method:"GET",
