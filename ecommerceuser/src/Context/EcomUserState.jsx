...
const EcomUserState = ({children}) => {
    ...
    const handlePayment =async(userId,receipt,amount)=>{
        try{
            ...
            const {data} = await axios.post('https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/payment/createOrder',{
                amount:amount,
                currency:"INR",
                receipt:receipt,
                userId,
            ...
            const options ={
                ...
                handler:async (response) =>{
                    const verifyUrl = 'https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/payment/verifyPayment'
    ...
    const getProducts = async()=>{
        try{
            const data = await fetch('https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/allProduct',{
                method:"GET",
    ...
    const getnewProducts = async()=>{
        try{
            const data = await fetch("https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/newProduct",{
                method:"GET",
    ...
    const getfeatured = async()=>{
        try{
            const data = await fetch("https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/getFeatured",{
                method:"GET",
                headers:{
                    "Content-Type":"application/json"
                }
    ...
    const cartProducts = async() =>{
        try{
            const data = await fetch('https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/cartproduct',{
                method:"POST",
    ...
    const updatingAddress = async(phoneNo,address,postal,city,country) =>{
        ...
        try{
            ...
            const data = await fetch('https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/addingaddress',{
                method:"POST",
    ...
    const viewdetails = async() =>{
        try{
            ...
            const res = await fetch(`https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/viewsdetails/${usersId}`,{
                method:"GET",
    ...
    const productshowcase = async(productid) =>{
        try{
            const res = await fetch(`https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/product/${productid}`,{
                method:"GET",
    ...
    const findorders = async() =>{
        try{
            const res = await fetch(`https://vercel.com/navneet-shahis-projects-727aeff0/ecommercefullstack/6M542MdL4orWdEdcwTp6Ta58UWdR/user/order/${usersId}`,{
                method:"GET",
