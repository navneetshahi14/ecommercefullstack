...
const ProductBox = ({products}) => {
  ...
  return (
    <>
        <div className='flex flex-col items-center justify-center cursor-pointer overflow-hidden border-[1px] md:w-[25vw] w-[40vw] border-gray-800 rounded-md p-2 shadow-md ' >
            ...
            <div className="mt-2 min-w-[80%]  ">
                <h2 className=" font-normal text-inherit md:text-[1rem] text-lg  ">
                    {products.title}
                </h2>
                <div className="flex md:flex-row flex-col items-center justify-between mt-1 gap-2 ">
                    <div className='md:text-[0.9rem] text-[1rem] font-[500] md:w-auto w-full'>
                        ₹{products.price}
                    </div>
                    <div className='md:w-auto w-full flex items-center justify-center' >
                        <button onClick={()=>addtocart(products._id)} className='bg-transparent text-[0.75rem] md:text-lg w-[90%] md:w-auto p-4 rounded-lg flex items-center justify-center py-1 border-[1px] border-primary text-primary gap-1 hover:bg-primary hover:text-white hover:border-white '><i className="fa-solid fa-cart-shopping"></i>Add to Cart</button>
                    </div>
                </div>
            </div>
        </div>
